 ...
 */
export const getContactStats = asyncHandler(async (_req: Request, res: Response): Promise<void> => {
...
export const updateContactStatus = asyncHandler(
  async (req: Request, res: Response): Promise<void> => {
    ...
    logger.info('Contact status updated', { contactId: id, status: data.status });
    res.json(contact);
  }
);
